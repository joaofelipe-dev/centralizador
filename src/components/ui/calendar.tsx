...
import type { ClassNames, Formatters, Locale } from "react-day-picker";
    ...
    <DayPicker
      ...
      components={{
        ...
        DayButton: (dayButtonProps) => {
          return <CalendarDayButton {...dayButtonProps as any} locale={locale} />;
        },
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      data-day={day.toLocaleDateString(locale?.code)}
